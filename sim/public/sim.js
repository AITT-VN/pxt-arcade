...
(function (pxsim) {
    ...
    pxsim.initCurrentRuntime = (msg) => {
        ...
        if (!forcedUpdateLoop) {
            ...
            //}, 100)
            // Enable global keyboard shortcuts (like escape to exit fullscreen)
...
(function (pxsim) {
    ...
    class ScreenState {
        constructor(paletteSrc, w = 0, h = 0) {
            ...
            this.onChange = () => { };
            if (!paletteSrc)
                paletteSrc = ["#000000", "#ffffff", "#ff2121", "#ff93c4", "#ff8135", "#fff609", "#249ca3", "#78dc52", "#003fad", "#87f2ff", "#8e2ec4", "#a4839f", "#5c406c", "#e5cdc4", "#91463d", "#000000"];
